...
export default function RedeemPage() {
    ...
    const handleRedeem = async () => {
        try {
            ...
            if (res.ok) {
                toast.success(`Redeemed! +${data.reward} Points! 🎉`);
    ...
    return (
        <div className="p-4 max-w-md mx-auto text-center space-y-8 pt-20">
            <h1 className="text-3xl font-black text-wawag-blue">Redeem WAWAG</h1>
            ...
            <div className="bg-white/50 p-6 rounded-3xl">
                <p className="font-bold text-gray-600 mb-4">Required:</p>
